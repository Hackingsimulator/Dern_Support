        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ScheduledDate = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeProjectsDBset", x => new { x.ProjectID, x.EmployeeID });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "JobsDb",
                columns: new[] { "Id", "Description", "Priority", "ScheduledDate", "Title" },
                values: new object[,]
                {
                    { 1, "Fix WiFi connectivity issue in the office.", "High", "", "Network Issue Resolution" },
                    { 2, "Install Visual Studio on employee laptops.", "High", "", "Install Software" },
                    { 3, "Replace faulty RAM in server rack 1.", "Medium", "", "Hardware Upgrade" },
                    { 4, "Perform routine maintenance on printers in all offices.", "Low", "", "Printer Maintenance" },
                    { 5, "Create new user accounts for incoming employees.", "Medium", "", "User Account Setup" }
                });
